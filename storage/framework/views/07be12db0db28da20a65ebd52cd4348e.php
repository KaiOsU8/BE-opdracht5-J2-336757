...
<?php $component->withAttributes([]); ?>
    <div class="flex justify-center flex-col items-center">
        <h1 class="text-center text-4xl m-20">Leveringsinformatie</h1>
            <?php $__currentLoopData = $products->productPerLeverancier; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productPerLeverancier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr class="text-xl">
                ...
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="border-solid border-2 border-sky-400"><?php echo e($product->DatumLevering); ?></td>
                        <td class="border-solid border-2 border-sky-400"><?php echo e($product->Aantal); ?></td>
                        <td class="border-solid border-2 border-sky-400"><?php echo e($product->DatumEerstVolgendeLevering); ?></td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </table>
